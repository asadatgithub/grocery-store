...
class OrdersPage extends StatefulWidget {
  const OrdersPage({super.key, required this.email, required this.loginType});
  final String email;
  final String loginType;
  @override
  State<OrdersPage> createState() => _OrdersPageState(email, loginType);
}
...
class _OrdersPageState extends State<OrdersPage> {
  ...
  _OrdersPageState(this.email, this.loginType);
  @override
          ...
          child: (user != null)
              ? Column(
                  children: [
                    ...
                    Expanded(
                        child: FutureBuilder(
                            future: OrderDatabase.getOrders(email),
                            builder:
                              ...
                              if (snapshot.data == null) {
                                ...
                                return Center(
                                  child: Text("No Orders Yet $email",
